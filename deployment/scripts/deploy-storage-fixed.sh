...
# Deploy Fixed Storage Stack
# Fixes the CloudWatchConfigurations issue in S3 bucket notification
...
TEMPLATE_FILE="$CLOUDFORMATION_DIR/03-storage-fixed.yaml"

print_info "Deploying fixed storage stack..."
...
print_info "Creating new storage stack with fixed template..."
