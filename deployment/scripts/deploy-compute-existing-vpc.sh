...
# Deploy Compute Stack for Existing VPC
# Deploys ECS cluster, ALB, and auto-scaling configuration
...
ENVIRONMENT="prod"
STACK_NAME="$PROJECT_NAME-$ENVIRONMENT-compute"
...
TEMPLATE_FILE="$CLOUDFORMATION_DIR/04-compute-existing-vpc.yaml"

print_info "Deploying compute stack for existing VPC..."
...
print_info "Creating compute stack..."
aws cloudformation create-stack \
    ...
    --parameters "ParameterKey=Environment,ParameterValue=$ENVIRONMENT" \
                 ...
                 "ParameterKey=BackendDesiredCount,ParameterValue=1" \
...
if [ $? -eq 0 ]; then
    print_status "Compute stack deployed successfully!"
    ...
    print_info "🌐 Application Load Balancer URL: http://$ALB_DNS"
    
else
    print_error "Compute stack deployment failed!"
