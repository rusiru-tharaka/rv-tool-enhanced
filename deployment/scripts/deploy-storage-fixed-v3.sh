...
# Deploy Fixed Storage Stack V3
# Final fix for CloudWatchConfigurations and IAM ARN format issues
...
TEMPLATE_FILE="$CLOUDFORMATION_DIR/03-storage-fixed-v3.yaml"

print_info "Deploying fixed storage stack v3..."
...
print_info "Creating new storage stack with fixed template v3..."
